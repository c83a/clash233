...
update_gfwlist_file() {
	...
	if [ "$ss_3p_gfwlist" = "1" ] ; then
		...
		url='xttps://cdn.jsdelivr.net/gh/gfwlist/gfwlist/gfwlist.txt'
		raw_url='xttps://raw.githubusercontent.com/gfwlist/gfwlist/master/gfwlist.txt'
	...
	if [ "$ss_3p_kool" = "1" ] ; then
		...
		url='xttps://cdn.jsdelivr.net/gh/hq450/fancyss/rules/gfwlist.conf'
		raw_url='xttps://raw.githubusercontent.com/hq450/fancyss/master/rules/gfwlist.conf'
...
update_chnlist_file() {
	...
	rm -f $tmp_down_file
	url='xttps://cdn.jsdelivr.net/gh/felixonmars/dnsmasq-china-list/accelerated-domains.china.conf'
	raw_url='xttps://raw.githubusercontent.com/felixonmars/dnsmasq-china-list/master/accelerated-domains.china.conf'
	wgetcurl_checkmd5 $tmp_down_file "$url" "$raw_url" N 5
...
update_chnroute_file() {
	...
	url='xttps://cdn.jsdelivr.net/gh/17mon/china_ip_list/china_ip_list.txt'
...
#edit by user start
 #       [ "$gid_owner" != "0" ] &&     $1 -t nat -I SSTP_OUTPUT -p tcp -m set --match-set $sstp_dst_dns_fw_setname dst -j SSTP_WAN_DNS
#edit by user end
